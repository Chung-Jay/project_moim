...
public class MemberActivity extends AppCompatActivity
    ...
    // URL
    String URLPermit = "http://192.168.1.94:8080/moim.4t.spring/updateMem.tople";
    String URLKickOut = "http://192.168.1.94:8080/moim.4t.spring/dropUser.tople"; // 파라미터 뭐 보내줘야하는지
    // 모임코드로 모임에 속한 유저들의 정보 얻어오기
    String URLTotUsers = "http://192.168.1.94:8080/moim.4t.spring/testMoimUsets.tople";
