...
public class AdminActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String URLUser = "http://192.168.1.94:8080/moim.4t.spring/selectUserMoimMem.tople";
    // 모임코드로 모임삭제
    String URLDelete = "http://192.168.1.94:8080/moim.4t.spring/deleteMoim.tople";
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.button1) {     // 메세지보내기
            ...
            startActivity(intent);
        } else if(v.getId() == R.id.button4) {      // 모임삭제
    ...
    class HttpResponseDelete extends AsyncHttpResponseHandler {
        ...
        @Override
        public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
            Toast.makeText(getApplicationContext(), "통신 실패3", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class HttpResponseWithdraw extends AsyncHttpResponseHandler {
        ...
        @Override
        public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
            Toast.makeText(getApplicationContext(), "통신 실패4", Toast.LENGTH_SHORT).show();
        }
    }
}
